...
def _contained(path: Path, root: Path) -> None:
    ...
    cursor = path.parent.resolve(strict=False)
...
def release_lock(
    ...
    *,
    ...
    # Re-read immediately before removal so a replacement owner cannot be
    # accidentally deleted after a stale-owner race.
