...
| Deployment reliability | `IN_PROGRESS` | Clean-source minimal Vercel build passes at 18 files and 834,206 bytes; the data snapshot is 37,463 deterministic-gzip bytes and real-data publication remains correctly rejected as degraded/not ready. |
