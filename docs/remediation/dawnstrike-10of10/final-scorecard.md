...
| Deployment reliability | `PREVIEW_VERIFIED` | Clean-source minimal Vercel build passes with zero forbidden files; preview `dpl_2DnSdAdjhEr1mnSt22uBXMaPSwwQ` returns matching health/readiness/manifest evidence and remains correctly degraded at HTTP 503. |
