...
| Deployment reliability | `IN_PROGRESS` | Clean-source minimal Vercel build passes at 18 files and 861,926 bytes; the data snapshot is 38,425 deterministic-gzip bytes and real-data publication remains correctly rejected as degraded/not ready. |
