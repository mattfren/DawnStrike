...
| Deployment reliability | `PREVIEW_VERIFIED_DEGRADED` | Clean-source minimal Vercel build passes at 18 files / 861,548 bytes including diagnostics, with zero forbidden files; preview `dpl_EK3mf9AHCYeaZrtivRiXXyTc2Hyb` returns matching health/readiness/manifest evidence and remains correctly degraded at HTTP 503. |
