...
| Deployment reliability | `BLOCKED_EXTERNAL` | Clean-source artifact packaging passes; local Vercel build requires missing `uv`, and real-data publication remains correctly rejected as degraded. |
