...
| Vercel packaging | `LOCAL_VERIFIED` | Clean build source SHA `edd228ae1e2d56631b6684458425c653b2b3814f` produces an 18-file, 861,926-byte native stage with zero forbidden files; the real snapshot is 632,094 raw bytes / 38,425 deterministic-gzip bytes and remains correctly rejected as degraded/not ready. |
