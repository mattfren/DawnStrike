...
| Vercel packaging | `BLOCKED_EXTERNAL` | Native static output plus liveness/readiness functions pass source/artifact checks; local CLI packaging requires `uv`, which is not installed. |
