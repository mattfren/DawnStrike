...
- Current source SHA-256:
  `cdd1bc5d1007562ba4d1983ac2c797593e646cddfc4b46f378fcce191ef44eea`
- Current source last write: `2026-08-27T20:18:22.3423688Z`
- The original audit read source hash
  `fd9d7f584242fa802f25c890c160c01ff7cd31164e7b429c74a096aba26f1df9` at
  `2026-08-26T20:39:13Z`, but those exact mutable aggregate bytes were not retained. That old hash
  is therefore historical audit lineage, not a currently reproducible artifact claim.
...
- Reproducible current materialization, restricted to signal dates through `2026-08-26`: 449
  accepted rows, 295 unique date/symbol/direction episodes, 43 closed trades, 15 wins, 28 losses,
  and -$5,388.47 net P&L. The four additional closures are later lifecycle materializations for
  the same pre-cutoff signal cohort; this is why the accepted/episode counts match the original
  audit while the close and return figures do not. Including the `2026-08-27` signal cohort gives
  465 accepted rows and 303 unique episodes, with the same 43 closed trades at this snapshot.
...
| --- | --- | --- | --- |
| `bullish_fvg_continuation` | 58 accepted; 9 closed; 2W/7L; -$981.95; PF 0.520; mean -1.831%; ex-best -$1,903.36 | The daily-OHLC construction is only a proxy for an intraday fair-value gap, and one large win masks weak continuation quality. | Keep the champion frozen. Evaluate a shadow challenger with explicit proxy labeling plus trend, gap-quality, close-quality, and participation guards. |
| `cross_sectional_relative_strength` | 55 accepted; 7 closed; 1W/6L; -$2,032.71; PF 0.035; mean -3.584%; ex-best -$2,107.08 | This is the clearest negative forward signal, with likely rank-margin, rotation, and portfolio-concentration failure. | Do not loosen rank thresholds. Add point-in-time rank margin, sector/correlation concentration, and capacity traces to a challenger; require committed closes before promotion. |
...
| `volatility_contraction_breakout` | 14 accepted; 4 closed; 2W/2L; +$385.07; PF 2.737; mean +1.627%; ex-best -$57.31 | It is the most promising observed result, but four closes and best-trade dependence cannot establish an edge. | Preserve v1. Run a conservative shadow challenger with direction, liquidity, participation, and downside-expansion predicates; no automatic promotion. |
