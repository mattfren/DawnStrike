"""StockAnalysis daily movers provider."""
...
class StockAnalysisDailyMoversProvider:
    ...
    def collect(self, *, market_date: str, out_dir: str | Path) -> dict[str, Any]:
        ...
        if self.config.save_raw:
            debug_path = output_dir / "stockanalysis_daily_movers.html"
        ...
        rows, rejected, rejection_counts = normalize_daily_mover_rows(
            ...
            source=self.source.name or "stockanalysis_daily_movers",
