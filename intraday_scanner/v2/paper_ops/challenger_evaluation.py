...
def _evaluate_registration(
    *,
    ...
    champion_metrics = _metrics(champion_aligned, len(expected_dates))
    candidate_metrics = _metrics(candidate_aligned, len(expected_dates))
...
def _no_challenger_proposal(
    ...
    metrics = _metrics(evidence.eligible, len(evidence.expected_dates))
