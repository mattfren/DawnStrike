        ...
        source_artifacts.append(
            {
                ...
                "lineage_builder_id": source_binding.get("lineage_builder_id"),
                "lineage_transformation_id": source_binding.get("lineage_transformation_id"),
                "lineage_schema_version": source_binding.get("lineage_schema_version"),
                "reconstitution_id": source_binding.get("reconstitution_id"),
...
def _validate_source_binding(
    ...
    *,
    ...
    binding: dict[str, Any] = {
        ...
        "lineage_builder_id": root.get("lineage_builder_id") if root else None,
        "lineage_transformation_id": root.get("lineage_transformation_id") if root else None,
        "lineage_schema_version": root.get("lineage_schema_version") if root else None,
        "reconstitution_id": root.get("reconstitution_id") if root else None,
        "derived_effective_date": None,
        "derived_member_set_hash_sha256": None,
        "derived_membership_count": 0,
    }
